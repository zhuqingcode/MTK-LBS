...
#define OA_GPS_SCHEDULER_PERIOD 1000//500 //ms
...
void GPS2Point_Distance(oa_double New_Point_Lon,oa_double New_Point_Lat,oa_double Old_Point_Lon,oa_double Old_Pont_Lat, oa_double *res );//#endif
//------------------------------------------
#endif
